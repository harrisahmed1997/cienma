...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" type="image/png" href="{{url('/img/favcion.png')}}" />
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" type="text/css" href="{{url('/css/bootstrap.min.css')}}" media="all" />
    <!-- Slick nav CSS -->
    <link rel="stylesheet" type="text/css" href="{{url('/css/slicknav.min.css')}}" media="all" />
    <!-- Iconfont CSS -->
    <link rel="stylesheet" type="text/css" href="{{url('/css/icofont.css')}}" media="all" />
    <!-- Owl carousel CSS -->
